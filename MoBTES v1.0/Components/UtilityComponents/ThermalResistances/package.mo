within MoBTES.Components.UtilityComponents;
package ThermalResistances "thermal resistances local problem"
	extends Modelica.Icons.Package;
	annotation(
		Documentation(info="<html>
<p>
Specialized thermal resistances.
</p>
