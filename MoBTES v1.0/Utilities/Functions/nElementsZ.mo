...
<p>
Returns the number of vertical elements of the global model's mesh. This is used as input for the actual meshing function and is a workaround for function handling of arrays with variable size. The function body is equal to the body of the function <a href=\"modelica://MoBTES.Utilities.Functions.ElementHeights\">ElementHeights</a>.
<h4>
